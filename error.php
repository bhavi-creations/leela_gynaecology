      ...
      <div class="container">
        <div class="cs_error_content">
          <div class="cs_error_thumbnail">
            <img src="assets/img/error_thumbnail.png" alt="Image">
          </div>
          ...
          <a href="index.php" class="cs_btn cs_style_1 cs_color_2">
                ...
                <li>
                  <div class="cs_recent_post">
                    ...
                    <div class="cs_recent_post_right">
                      ...
                      <h3 class="cs_recent_post_title"><a href="blog-details.php">The Medical Of This Working Health</a></h3>
                    </div>
                  </div>
                </li>
              </ul>
