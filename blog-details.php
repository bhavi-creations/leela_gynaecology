            ...
            <div class="row cs_row_gap_30 cs_gap_y_30">
              ...
              <div class="col-md-5">
                <div class="cs_card cs_style_8">
                  <h3 class="cs_card_title">Medical Lab:</h3>
          ...
          <div class="cs_sidebar cs_style_1">
            ...
            <div class="cs_sidebar_widget cs_service cs_bg_filed" data-src="assets/img/suegery_overlay.jpg">
              <div class="cs_iconbox cs_style_11">
                ...
                <a href="service-details.php" class="cs_iconbox_btn cs_center"><i
            ...
            <div class="cs_sidebar_widget cs_radius_15">
              ...
              <div class="cs_post cs_style_2">
                <a href="blog-details-right-sidebar.php" class="cs_post_thumb_thumbnail cs_type_2 cs_zoom">
                ...
                <div class="cs_post_info">
                  <div class="cs_post_meta"><i class="fa-regular fa-calendar-days"></i>
                    June,10,2024</div>
                  <h3 class="cs_post_title mb-0"><a href="blog-details.php">We play chimney pot <br> Chip bonne.</a>
                  </h3>
                </div>
              </div>
              <div class="cs_post cs_style_2">
                <a href="blog-details-right-sidebar.php" class="cs_post_thumb_thumbnail">
              ...
              <li>
                <div class="cs_recent_post">
                  ...
                  <div class="cs_recent_post_right">
                    ...
                    <h3 class="cs_recent_post_title"><a href="blog-details.php">We round Solution york Blog</a></h3>
                  </div>
                </div>
              </li>
              <li>
                <div class="cs_recent_post">
                  ...
                  <div class="cs_recent_post_right">
                    ...
                    <h3 class="cs_recent_post_title"><a href="blog-details.php">The Medical Of This Working Health</a>
                    </h3>
                  </div>
                </div>
              </li>
