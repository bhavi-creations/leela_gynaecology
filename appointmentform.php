...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    try {
        ...
        // Recipients
        $mail->setFrom('manimalladi05@gmail.com', 'Leela Gynaecologist' ); // Your Gmail email and name
        $mail->addAddress('manimalladi05@gmail.com', 'Leela Gynaecologist'); // Recipient's email and name
