    ...
    <div class="container">
      <div class="row cs_gap_y_40">
        ...
        <div class="col-xl-8 col-lg-7">
          <div class="cs_service_details_thumbnail">
            <img src="assets/img/service_details_1.jpg" alt="Image">
          </div>
        </div>
      </div>
      ...
      <div class="cs_service_details">
        ...
        <div class="row cs_gap_y_30">
          <div class="col-lg-6">
            <div class="cs_service_details_thumbnail">
              <img src="assets/img/service_details_2.jpg" alt="Image">
            </div>
          </div>
          <div class="col-lg-6">
            <div class="row cs_gap_y_30">
              <div class="col-xl-6 col-lg-12 col-md-6">
                <div class="cs_iconbox cs_style_2 cs_radius_15 cs_gray_bg">
                  ...
                  <h3 class="cs_iconbox_title"><a href="service-details.php">Service & Check</a></h3>
              ...
              <div class="col-xl-6 col-lg-12 col-md-6">
                <div class="cs_iconbox cs_style_2 cs_radius_15 cs_gray_bg">
                  ...
                  <h3 class="cs_iconbox_title"><a href="service-details.php">Medical Care</a></h3>
                  <p class="cs_iconbox_subtitle m-0">Medical competitor research startup to financial</p>
                </div>
              </div>
            </div>
